# source: https://github.com/5hun/bundle-method/blob/master/bundle.py
...
class ProximalBundleMethod:
    ...
    The implementation is based on the figure 7.3 of [1]_ .
    ...
    def _add_cut(self, obj, x, subgrad):
    ...
    def _solve(self):
        """ Solve the problem from bundle method.

        Returns:
            np.ndarray: The optimal x.
        """
        if self._sense == max:
        ...
        # REVIEW: GUROBI is a better choice, same as nsopy
        prob.solve(cp.GUROBI, verbose=False)
