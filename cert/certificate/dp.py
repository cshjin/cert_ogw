...
def exact_solver_wrapper(A_org, Q, p, L, delta_l, delta_g, constr='1+2'):
    """
...
def local_budget_precompute(A_org, Q, p, L, delta_l):
    ...
    for i in range(1, nG + 1):    # looping each row of A
        ...
        chunk_edges_mtx, chunk_no_edges_mtx = np.zeros(
            (possible_denomi, delta_l + 1)), np.zeros((possible_denomi, delta_l + 1))
